...
weightOfR = 225/450.
inverseWeightOfR = 225/450.
X = code.make_prototyped_random_codes(M=noOfTrainData, n=lenOfInput, p=10, weight=[weightOfR, inverseWeightOfR],
...
fit = model.fit(X, T, nb_epoch=noOfEpochs, batch_size=32, validation_split=modelValidationDataRatio,
                shuffle=True, callbacks=[activationCallback, csv_logger, checkpointer, early_stopper])
